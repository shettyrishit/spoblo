...
<div class="mainContainer MainBnrContainer formContainer">
  ...
  <div class="loginContainer">
    <div class="loginForm">
      ...
      <p>To reset your password, type password and confirm password.</p>
      <form class="loginMainForm" id="resetpassword-form" action="php/spoblo_forgotpassword.php" method="post">
        ...
        <div class="logReglog">
          <button type="submit" id="resetpassword-submit" name="resetpassword-submit" class="btn3">Save</button>
        </div>
...
else
{
    ...
    $_SESSION['spoblo_msg']='Invalid approach, You have already logged in.';
